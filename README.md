## Using LoFTR for feature matching

## Things added by me:

 - infer.py: gives matching features between two given images
 - out_fts.png: results obtained from two images
 - out_fts.txt: coordinates of matching features
...
[download link](https://drive.google.com/drive/folders/1DOcOPZb3-5cWxLqn256AhwUVjBPifhuf?usp=sharing)

In the code I have used: outdoor_ds.ckpt
...
cd weights
```
and move the downloaded .ckpt file in the 'weights' folder.

And this finally:

```shell
python infer.py --source_image {path to image 1} --other_image {path to the other image} --save_image_path {output_image.png} --save_feature_txt {output_txt.txt}
```



## Things added by me ends here!
